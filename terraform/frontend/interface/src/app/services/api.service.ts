...
export class ApiService {
  ...
  public upload_file_to_s3(presigned_url: string, file: any): Observable<any> { return this.http.put(presigned_url, file, { headers: { 'Content-Type': file.file_type } }); }
  ...
  public send_export_table_request(message: any): Observable<any> { return this.http.get(`${this.BASE_URI}/portal2_export_table&message=${JSON.stringify(message)}`, { headers: this.auth_header }); }

  public send_trusted_user_request(message: any): Observable<any> { return this.http.get(`${this.BASE_URI}/portal2_export_table&message=${JSON.stringify(message)}`, { headers: this.auth_header }); }
